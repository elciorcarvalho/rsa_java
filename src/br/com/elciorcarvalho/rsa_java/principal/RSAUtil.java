...
public class RSAUtil {
    ...
    public static void main(String[] args) 
            throws IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, BadPaddingException, IOException {
        String frase = null;
        ...
        try {
            ...
            System.out.println("Frase para criptografar: ");
            frase = in.readLine();
            
            String encryptedString = Base64.getEncoder().encodeToString(encrypt(frase, publicKey));
